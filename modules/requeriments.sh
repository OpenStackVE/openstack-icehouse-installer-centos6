...
yum -y install python-keystoneclient python-sqlalchemy0.7 python-migrate python-psycopg2 \
	MySQL-python python-tools sysfsutils sg3_utils genisoimage libguestfs glusterfs \
	glusterfs-fuse nfs-utils sudo sheepdog libguestfs-tools-c
...
yum -y install boost-program-options perl-DBD-MySQL wxBase wxGTK  wxGTK-gl libtool-ltdl \
	...
	python-ordereddict python-webob python-memcached python-oauthlib python-routes1.12 \
	...
	python-paste-deploy1.5 python-tempita python-chardet python-requests python-stevedore
